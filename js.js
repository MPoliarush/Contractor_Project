...
/* First carousel for desktop - 992px and more*/
...
if (imageWidth=='545px'){
    $('#slider_item_second').click(function(){
        $('#images_wrapper').css('right','480px')
        $('#slider_item_first').removeClass('active_slider');
        $('#slider_item_second').addClass('active_slider');
    });

    $('#slider_item_first').click(function(){
        $('#images_wrapper').css('right','0px')
        $('#slider_item_second').removeClass('active_slider');
        $('#slider_item_first').addClass('active_slider');
    })
...
//first carousel mobile //
if(imageWidth=='200px' || imageWidth=='230px'){
...
} else if (imageWidth=='190px'){
    $('#slider_item_second').click(function(){
        $('#images_wrapper').css('right','190px');
        $('#slider_item_first').removeClass('active_slider');
        $('#slider_item_third').removeClass('active_slider');
        $('#slider_item_second').addClass('active_slider');
        
    })
    $('#slider_item_third').click(function(){
        $('#images_wrapper').css('right','380px');
        $('#slider_item_second').removeClass('active_slider');
        $('#slider_item_first').removeClass('active_slider');
        $('#slider_item_third').addClass('active_slider');
    })
    $('#slider_item_first').click(function(){
        $('#images_wrapper').css('right','0px');
        $('#slider_item_third').removeClass('active_slider');
...
//Second carousel desktop - 992px and more//
...
if(cardWidth>'329px'){
    ...
    function handleTouchMove2(event){
        ...
        if (xDiff2<0 && cardWidth=='380px'){
            console.log("moved to the left")
            $('#images_block').css('right','180px');
            $('#testimonials_slider_item_back').removeClass('active_slider');
            $('#testimonials_slider_item_forth').addClass('active_slider');
        } else if (xDiff2<0 && cardWidth=='330px'){
            console.log("moved to the left")
...
} else if (cardWidth=='320px'){
        
        $('#testimonials_slider_item_forth').click(function(){
            $('#images_block').css('right','350px');
            $('#testimonials_slider_item_back').removeClass('active_slider');
            $('#testimonials_slider_item_forth').addClass('active_slider');
